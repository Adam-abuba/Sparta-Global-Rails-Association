...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { cost: @software.cost, developer_id: @software.developer_id, functional: @software.functional, name: @software.name, user_id: @software.user_id } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { cost: @software.cost, developer_id: @software.developer_id, functional: @software.functional, name: @software.name, user_id: @software.user_id } }
