...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { aaacompany: @developer.aaacompany, employees: @developer.employees, name: @developer.name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { aaacompany: @developer.aaacompany, employees: @developer.employees, name: @developer.name } }
